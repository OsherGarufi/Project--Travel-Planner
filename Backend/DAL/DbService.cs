...
public class DbService
{
    ...
    /// <summary>
    /// Returns all trips that belong to a specific user.
    /// </summary>
    ...
    /// <summary>
    /// Returns a single trip by id only if it belongs
    ...
    /// <summary>
    /// Creates a new trip in the database and returns
    /// the created trip.
    /// </summary>
    public async Task<Trip>
        CreateTripAsync(
    ...
    /// <summary>
    /// Deletes a trip only if it belongs to the specified user.
    /// </summary>
    ...
    /// <summary>
    /// Creates a user if it does not exist, or updates it
    ...
    /// <summary>
    /// Returns a user by Firebase UID, or null if the
    /// user does not exist.
    /// </summary>
    public async Task<AppUser?>
    ...
    /// <summary>
    /// Maps a database row into an AppUser model object.
    /// </summary>
    ...
    /// <summary>
    /// Maps a database row into a Trip model object.
    /// </summary>
    private static Trip MapTrip(
        NpgsqlDataReader reader
    )
    {
        return new Trip
