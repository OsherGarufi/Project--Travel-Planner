  ...
  const distanceValue =
    hasCoordinates && userPosition
      ...
      : Number.isFinite(attraction.providerDistance)
        ? formatDistance(attraction.providerDistance)
        : ''

  const distance =
    distanceValue && userPosition
      ? `${distanceValue} from you`
      : distanceValue
        ? `${distanceValue} from search center`
        : ''
    ...
    <article className="attraction-card">
      <div className="attraction-card__media">
        {imageUrl && failedImage !== imageUrl ? (
          ...
          <div
            className="attraction-card__fallback"
          ...
          >
            ...
            >
              <path
                d="M8 49 28 20l15 19 10-14 19 24H8Z"
                stroke="currentColor"
                strokeWidth="2"
      ...
      <div className="attraction-card__body">
        ...
        <div className="attraction-card__mobile-meta">
          {attraction.category && (
            <span>{attraction.category}</span>
          )}

          {attraction.category && distanceValue && (
        ...
        {distance && (
          <p className="attraction-card__distance">
            {distance}
          </p>
        )}
        ...
        <div className="attraction-card__description">
          ...
          {attraction.detailsLoading && (
            <span className="attraction-card__enriching">
              Adding place details…
            </span>
          )}

          {attraction.detailsError && (
            <span className="attraction-card__enriching">
              Extra details unavailable.
            </span>
          )}
        </div>
        ...
        {website && (
          <a
            className="attraction-card__website"
            href={website}
            target="_blank"
        ...
        <div className="attraction-card__actions">
          <div
            className="attraction-card__navigate"
            ref={root}
            onBlur={(event) => {
          ...
          >
            <button
              type="button"
              className="attractions-button attraction-card__action-button"
              ref={trigger}
            ...
            >
              <svg
                className="attraction-card__action-icon"
                viewBox="0 0 24 24"
                fill="none"
                aria-hidden="true"
              >
              ...
              <span className="attraction-card__action-label">
                Navigate
              </span>

              <span
                className="attraction-card__action-chevron"
                aria-hidden="true"
              >
                ⌄
              </span>
            ...
            {menuOpen && (
              <div
                className="attraction-card__menu"
                id={menuId}
                ref={menu}
                role="menu"
                aria-label={`Navigate to ${attraction.name}`}
          ...
          <button
            type="button"
            className="attractions-button attractions-button--primary attraction-card__action-button"
